...
export const en = {
  ...
  gallery: {
    title: "My photos",
    hint: "Choose who sees each photo",
    open: "Open the album",
    add: "Add photos",
    addOne: "Add photo",
    pick: "Choose photos",
    picked: "chosen",
    visibility: "Who can see these photos?",
    vPrivate: "Private",
    vPrivateHint: "Only you. Nobody at Fitness Guide can see them.",
    vMembers: "Members",
  ...
  medical: {
    ...
    titleInvalid: "A title can be at most 80 characters",
  ...
  feed: {
    title: "Member photos",
    subtitle: "Photos members chose to share",
    empty: "No shared photos yet",
    homeButton: "Member photos",
    like: "Like",
    unlike: "Unlike",
    likes: "likes",
    comments: "comments",
    ...
    report: "Report",
    reportReason: "What is wrong? (optional)",
    reportSend: "Send report",
    reported: "Report received. Thank you.",
    signInToLike: "Sign in as a member to like or comment",
    signInToComment: "Sign in as a member to comment",
    signInToReport: "Sign in as a member to report",
    commentInvalid: "A comment is 1 to 300 characters",
  ...
  moderation: {
    title: "Reports",
    subtitle: "What members flagged and nobody has looked at yet",
